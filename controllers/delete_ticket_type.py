...
class DeleteTicketTypeWindow(QMainWindow):
    def __init__(self):
        super().__init__()

        self.setWindowTitle("Excluir Tipo de Ingresso")
        ...
        self.delete_button = QPushButton("Excluir Tipo de Ingresso")
    ...
    def handle(self):
        ...
        try:
            ...
            self.show_message(
                "Erro",
                f"Erro ao excluir tipo de ingresso: {str(e)}",
                QMessageBox.Critical,
            )
            return

        self.show_message(
            "Sucesso", "Tipo de ingresso excluído com sucesso.", QMessageBox.Information
        )
