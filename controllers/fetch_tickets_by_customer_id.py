...
class FetchTicketsByCustomerIdWindow(QMainWindow):
    def __init__(self):
        super().__init__()

        self.setWindowTitle("Buscar Ingressos pelo ID do Cliente")
    ...
    def handle(self):
        ...
        try:
            tickets = fetch_tickets_by_customer_id.execute(customer_id)
            if tickets:
                ...
                self.show_message(
                    "Aviso",
                    "Nenhum ingresso encontrado para este cliente.",
